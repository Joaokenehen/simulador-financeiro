  ...
  return [
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "Erro no sistema! Um imposto foi pago em duplicidade e o reembolso vai demorar.", impact: { saudeFinanceira: +10, qualidadeVida: -10, reservaEmergencia: -50, custo: c(1800) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Tudo pago! O alívio de não ter dívidas compensa a queda na reserva.", impact: { saudeFinanceira: +20, qualidadeVida: +5, reservaEmergencia: -40, custo: c(1200) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Você organizou perfeitamente as contas e vai absorver as parcelas sem estresse.", impact: { saudeFinanceira: -20, qualidadeVida: +5, reservaEmergencia: 0, custo: c(200) } }
          ] 
        },
        { 
          text: `Fazer um empréstimo pessoal (Custo Base: R$ ${c(300)}/mês)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "Caiu no conto do empréstimo fácil! As taxas escondidas destruíram sua saúde financeira.", impact: { saudeFinanceira: -50, qualidadeVida: -20, reservaEmergencia: 0, custo: c(450) } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Pegou o empréstimo com um familiar a juros zero! Resolveu o problema rápido.", impact: { saudeFinanceira: -10, qualidadeVida: +10, reservaEmergencia: 0, custo: c(300) } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "A viagem foi um desastre! Choveu o tempo todo e você ainda gastou mais que o planejado.", impact: { saudeFinanceira: -40, qualidadeVida: -10, reservaEmergencia: -20, custo: c(1200) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "A viagem foi épica! Você se divertiu muito e recarregou as energias ao máximo.", impact: { saudeFinanceira: -30, qualidadeVida: +35, reservaEmergencia: -10, custo: c(800) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Você curtiu muito os bloquinhos perto de casa gastando quase nada!", impact: { saudeFinanceira: +10, qualidadeVida: +20, reservaEmergencia: 0, custo: c(150) } }
          ] 
        },
        { 
          text: `Maratona de séries em casa (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "A internet caiu e um cano estourou em casa. Feriado arruinado e custo surpresa!", impact: { saudeFinanceira: -10, qualidadeVida: -25, reservaEmergencia: -15, custo: c(400) } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Feriado relaxante! Você descansou perfeitamente e ficou imune às tentações.", impact: { saudeFinanceira: +20, qualidadeVida: +15, reservaEmergencia: 0, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "Você foi assaltado na mesma semana. Pânico, celular perdido e o boleto ficou.", impact: { saudeFinanceira: -50, qualidadeVida: -30, reservaEmergencia: 0, custo: c(4000) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Aparelho maravilhoso! A câmera e a velocidade aumentaram muito sua produtividade.", impact: { saudeFinanceira: -40, qualidadeVida: +25, reservaEmergencia: 0, custo: c(4000) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Ótimo custo-benefício. O sistema é limpo e faz tudo que você precisa super bem.", impact: { saudeFinanceira: -5, qualidadeVida: +15, reservaEmergencia: -20, custo: c(1200) } }
          ] 
        },
        { 
          text: `Mandar consertar a tela do antigo (Custo: R$ ${c(250)})`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "A tela nova parou de funcionar 3 dias depois. O barato saiu caro e você perdeu o dinheiro.", impact: { saudeFinanceira: -5, qualidadeVida: -15, reservaEmergencia: -5, custo: c(250) } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Técnico milagroso! O celular ficou novinho em folha e você economizou muito.", impact: { saudeFinanceira: +20, qualidadeVida: +5, reservaEmergencia: -5, custo: c(250) } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "Esqueceu os ovos no sol e eles derreteram completamente. Tristeza na família.", impact: { saudeFinanceira: -25, qualidadeVida: -15, reservaEmergencia: 0, custo: c(350) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "A família amou os presentes, brindes vieram certos e a data foi inesquecível.", impact: { saudeFinanceira: -20, qualidadeVida: +25, reservaEmergencia: 0, custo: c(350) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Você virou um chocolatier! Ficaram incríveis e todos amaram a dedicação.", impact: { saudeFinanceira: +15, qualidadeVida: +20, reservaEmergencia: 0, custo: c(70) } }
          ] 
        },
        { 
          text: `Ignorar a data (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "A família ficou extremamente chateada com a falta de chocolate. Clima pesadíssimo.", impact: { saudeFinanceira: +20, qualidadeVida: -25, reservaEmergencia: 0, custo: 0 } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Ninguém se importou com o marketing e o foco foi aproveitar a companhia um do outro.", impact: { saudeFinanceira: +25, qualidadeVida: +10, reservaEmergencia: 0, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "Comida péssima, restaurante lotado e estressante. Dinheiro muito mal gasto.", impact: { saudeFinanceira: -30, qualidadeVida: -10, reservaEmergencia: 0, custo: c(600) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Ela chorou de emoção! Atendimento impecável, um dia inesquecível para a memória.", impact: { saudeFinanceira: -25, qualidadeVida: +35, reservaEmergencia: 0, custo: c(600) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Sua receita estava digna de MasterChef! O tempero caseiro trouxe memórias maravilhosas.", impact: { saudeFinanceira: +10, qualidadeVida: +25, reservaEmergencia: 0, custo: c(150) } }
          ] 
        },
        { 
          text: `Apenas um abraço (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "Ela disse que não tem problema, mas você sentiu a decepção profunda nos olhos dela.", impact: { saudeFinanceira: +15, qualidadeVida: -25, reservaEmergencia: 0, custo: 0 } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "A presença era o melhor presente. Vocês passaram o dia inteiro conversando felizes.", impact: { saudeFinanceira: +20, qualidadeVida: +15, reservaEmergencia: 0, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "Curso horrível! Era só marketing vazio e o produtor sumiu sem dar reembolso.", impact: { saudeFinanceira: -5, qualidadeVida: -15, reservaEmergencia: -40, custo: c(800) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Certificado de peso! Você logo conseguiu aplicar e ser notado(a) no trabalho.", impact: { saudeFinanceira: +30, qualidadeVida: +25, reservaEmergencia: -40, custo: c(800) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Decisão correta! O pequeno gasto mensal se pagou rápido com o networking que você fez.", impact: { saudeFinanceira: +10, qualidadeVida: +20, reservaEmergencia: 0, custo: c(90) } }
          ] 
        },
        { 
          text: `Não fazer o curso (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "Um colega menos experiente fez o curso e pegou a promoção no seu lugar. Frustração total.", impact: { saudeFinanceira: +10, qualidadeVida: -20, reservaEmergencia: 0, custo: 0 } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Você garimpou e achou os exatos mesmos conteúdos perdidos pelo YouTube de graça!", impact: { saudeFinanceira: +25, qualidadeVida: +15, reservaEmergencia: 0, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "O hotel era sujo, choveu granizo e você pegou uma gripe de cama. Férias perdidas.", impact: { saudeFinanceira: -40, qualidadeVida: -15, reservaEmergencia: -10, custo: c(1600) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Vinhos, lareira e paisagens de cinema. Você voltou como uma nova pessoa!", impact: { saudeFinanceira: -30, qualidadeVida: +45, reservaEmergencia: -10, custo: c(1500) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Achou um chalé de fazenda desconhecido pelas massas, super barato e aconchegante!", impact: { saudeFinanceira: +10, qualidadeVida: +25, reservaEmergencia: 0, custo: c(200) } }
          ] 
        },
        { 
          text: `Ficar em casa (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "Ficar rolando o feed e vendo os amigos em Gramado te afundou numa fossa mental.", impact: { saudeFinanceira: +20, qualidadeVida: -25, reservaEmergencia: 0, custo: 0 } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Você zerou os jogos que estavam parados e dormiu 10h por noite. Que delícia!", impact: { saudeFinanceira: +25, qualidadeVida: +20, reservaEmergencia: 0, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "A tela chegou totalmente trincada. A transportadora culpou a loja, que sumiu. Pesadelo.", impact: { saudeFinanceira: -45, qualidadeVida: -20, reservaEmergencia: -25, custo: c(2500) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Verdadeiro cinema em casa! A imagem e som surreais compensaram toda a tristeza de Agosto.", impact: { saudeFinanceira: -35, qualidadeVida: +35, reservaEmergencia: -20, custo: c(2500) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Escolha inteligentíssima! O modelo é rápido, nítido e seu orçamento ficou intacto.", impact: { saudeFinanceira: -10, qualidadeVida: +20, reservaEmergencia: -10, custo: c(1300) } }
          ] 
        },
        { 
          text: `Não comprar nada (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "Sua TV velha soltou fumaça e queimou de vez! Agora sem promoções ativas, teve prejuízo maior.", impact: { saudeFinanceira: -15, qualidadeVida: -20, reservaEmergencia: -15, custo: c(1600) } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Resistência de ferro! A velha TV ainda serve muito bem e seu caixa está forte.", impact: { saudeFinanceira: +30, qualidadeVida: +5, reservaEmergencia: +15, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "Alguém bebeu muito vinho caro, a conta multiplicou e você precisou cobrir a falta.", impact: { saudeFinanceira: -25, qualidadeVida: -10, reservaEmergencia: -10, custo: c(350) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Noite de gala! O bife derretia na boca e de quebra rolou um ótimo networking com o chefe.", impact: { saudeFinanceira: -10, qualidadeVida: +30, reservaEmergencia: 0, custo: c(200) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Você deu sorte! Outra pessoa quis pagar a conta inteira para todos, e você jantou de graça!", impact: { saudeFinanceira: +10, qualidadeVida: +25, reservaEmergencia: 0, custo: 0 } }
          ] 
        },
        { 
          text: `Dar uma desculpa (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "Uma foto sua na padaria vazou. Fofocas correm no escritório de que você é antissocial.", impact: { saudeFinanceira: +15, qualidadeVida: -25, reservaEmergencia: 0, custo: 0 } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Eles mandaram mensagem dizendo que o restaurante era uma furada! Você riu de alívio no sofá.", impact: { saudeFinanceira: +20, qualidadeVida: +15, reservaEmergencia: 0, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "Brinquedo de plástico frágil. A criança quebrou antes de ir dormir e começou a chorar.", impact: { saudeFinanceira: -25, qualidadeVida: -10, reservaEmergencia: 0, custo: c(400) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Sorrisos imensos e abraços apertados! Elas largaram os tablets e brincaram a semana toda.", impact: { saudeFinanceira: -15, qualidadeVida: +30, reservaEmergencia: 0, custo: c(400) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Brincar ao ar livre gerou memórias nostálgicas e uma tarde deliciosa e econômica.", impact: { saudeFinanceira: +15, qualidadeVida: +25, reservaEmergencia: 0, custo: c(80) } }
          ] 
        },
        { 
          text: `Sem presente (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "As crianças te chamaram de pão-duro em público! Que vergonha gigantesca na família.", impact: { saudeFinanceira: +15, qualidadeVida: -30, reservaEmergencia: 0, custo: 0 } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Eles ganharam TANTOS brinquedos dos avós que sequer notaram a falta do seu pacote.", impact: { saudeFinanceira: +25, qualidadeVida: +10, reservaEmergencia: 0, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "Metade comprou pela metade do dobro. E o outro site clonou seu cartão de crédito.", impact: { saudeFinanceira: -40, qualidadeVida: -30, reservaEmergencia: -10, custo: c(1400) } },
            ...
            { minRoll: 10, maxRoll: 20, type: 'good', message: "A promoção era um bug real de uma grande loja! Tudo pela metade do preço! Você se deu super bem.", impact: { saudeFinanceira: -20, qualidadeVida: +35, reservaEmergencia: 0, custo: c(600) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Mestre do garimpo de descontos! Produto necessário, barato, e entregue no dia seguinte.", impact: { saudeFinanceira: +20, qualidadeVida: +20, reservaEmergencia: 0, custo: c(250) } }
          ] 
        },
        { 
          text: `Ignorar a data (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "Segunda-feira sua geladeira pifou! Acabou a Black Friday e os preços voltaram pro teto.", impact: { saudeFinanceira: -15, qualidadeVida: -20, reservaEmergencia: -30, custo: c(1800) } },
            ...
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Nirvana financeiro. Não precisa de nada e seu patrimônio sorri no fim do mês.", impact: { saudeFinanceira: +30, qualidadeVida: +15, reservaEmergencia: +15, custo: 0 } }
          ] 
        }
      ]
    },
    {
      ...
      options: [
        { 
          ...
          outcomes: [
            { minRoll: 1, maxRoll: 4, type: 'bad', message: "A bebida secou cedo, choveu no churrasco e rolou briga política pesada no peru. Decepção.", impact: { saudeFinanceira: -45, qualidadeVida: -30, reservaEmergencia: -20, custo: c(1800) } },
            { minRoll: 5, maxRoll: 9, type: 'neutral', message: "Festa padrão. Encheram a pança, sobraram restos por 3 dias, mas sem magia e muita conta pra Janeiro.", impact: { saudeFinanceira: -35, qualidadeVida: +15, reservaEmergencia: -20, custo: c(1800) } },
            { minRoll: 10, maxRoll: 20, type: 'good', message: "Um filme de Hollywood. A família reunida rindo e trocando memórias. Valeu cada centavo da ceia!", impact: { saudeFinanceira: -20, qualidadeVida: +50, reservaEmergencia: -10, custo: c(1800) } }
          ] 
        },
        { 
          ...
          outcomes: [
            ...
            { minRoll: 13, maxRoll: 20, type: 'good', message: "Divertido, simples e cheio de amor. O amigo oculto de presentes engraçados roubou a cena.", impact: { saudeFinanceira: +20, qualidadeVida: +30, reservaEmergencia: +5, custo: c(300) } }
          ] 
        },
        { 
          text: `Ignorar o Natal e investir (Custo: R$ 0)`, 
          outcomes: [
            { minRoll: 1, maxRoll: 10, type: 'bad', message: "Fama de Scrooge sovina! Foi excluído do Zap da família e passou o sino da meia-noite infeliz.", impact: { saudeFinanceira: +40, qualidadeVida: -40, reservaEmergencia: +30, custo: 0 } },
            { minRoll: 11, maxRoll: 15, type: 'neutral', message: "Se empanturrou de miojo sozinho, viu um filme, foi dormir e o dinheiro continuou rendendo SELIC.", impact: { saudeFinanceira: +45, qualidadeVida: -10, reservaEmergencia: +35, custo: 0 } },
            { minRoll: 16, maxRoll: 20, type: 'good', message: "Paz e silêncio. Um retiro espiritual pessoal e com seu suado 13º rendendo muito na carteira.", impact: { saudeFinanceira: +50, qualidadeVida: +15, reservaEmergencia: +45, custo: 0 } }
          ] 
        }
      ]
    }
